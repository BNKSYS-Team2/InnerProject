...
const isBookable = async () => {
  ...
  const startDt = startDateD.substring(0,4) + startDateD.substring(5,7) + startDateD.substring(8, 10);
  const clientNo = []
...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    const startDt = startDateD.substring(0,4) + startDateD.substring(5,7) + startDateD.substring(8, 10) + startTimeT.substring(0, 2);
    const endDt = endDateD.substring(0,4) + endDateD.substring(5,7) + endDateD.substring(8, 10) + endTimeT.substring(0, 2);
    ...
    <>
      ...
      <div className="distribute container">
        ...
        <div className="selectPM d-flex justify-content-center">
          <div className="row">
            {distUnit ? distUnit.map((unit) => <SelectPMList key={unit.id} unit={unit} setSelPmNo={setSelPmNo} selPmNo={selPmNo}  />) : null}
          </div>
        </div>
      {/* 예약 날짜 선택 */}
      <div className="row">
